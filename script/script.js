document.getElementById("Concatenate").onclick=function(){
 ...
 document.getElementById("ifnested").onclick=function(){
     ...
     if(userName==="Muhammad Umar"){
         let password = prompt("Enter Your password")
         if(password === "umar@222176"){
         ...
         document.getElementById("output").innerHTML="Wrong userNAme <br> Correct user name is Muhammad Umar"
     }
 }
 ...
 document.getElementById("login").onclick = function(){
     ...
     if(Username ==="Muhammad Umar"){
         if(Password==="umar@222176"){
             ...
             document.getElementById("output").innerHTML="incorrect password or username <br> use Muhammad Umar as username or umar@222176 as password "
         }
     }
     else{
